...
More standards compliant PDF for professional printing. Derived from 
&#39;mirage335_documents&#39; .
...
_t '
scriptedIllustrator_markup_uk4uPhB663kVcygT0q --><!-- # --><pre style="margin-top: 0px;margin-bottom: 0px;white-space: pre-wrap;">
https://github.com/mirage335/mirage335_documents
<!-- # --></pre><!-- scriptedIllustrator_markup_uk4uPhB663kVcygT0q
'
 '_heading1' 'Copyright'
if false; then true; # -->
...
zPresentation-mirage335_documents is free software: you can redistribute it 
and/or modify
it under the terms of the GNU Affero General Public License as published by
the Free Software Foundation, either version 3 of the License, or
(at your option) any later version.

zPresentation-mirage335_documents is distributed in the hope that it will 
be useful,
...
along with zPresentation-mirage335_documents.  If not, see 
