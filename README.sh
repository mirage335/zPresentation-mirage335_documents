...
See license.txt for zPresentation-mirage335_documents license conditions.


More standards compliant PDF for professional printing. Derived from &#39;mirage335_documents&#39; .'
_t '


'
_heading1 'Reference'
_t 'https://github.com/mirage335/mirage335_documents'

_heading1 'Copyright'
_t '
This file is part of zPresentation-mirage335_documents.

zPresentation-mirage335_documents is free software: you can redistribute it and/or modify
it under the terms of the GNU Affero General Public License as published by
the Free Software Foundation, either version 3 of the License, or
(at your option) any later version.

zPresentation-mirage335_documents is distributed in the hope that it will be useful,
but WITHOUT ANY WARRANTY; without even the implied warranty of
MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
GNU Affero General Public License for more details.

You should have received a copy of the GNU Affero General Public License
along with zPresentation-mirage335_documents.  If not, see &lt;http://www.gnu.org/licenses/&gt;.
'
_t '
